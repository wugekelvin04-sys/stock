...
import { getQuotes, getHistory, getOptionChain, getIntraday, getPrevDayIntraday, getOptionDates, getOptionsByDate, searchSymbols, getGainers, getLosers, getNews, getIndices, getSectors } from '../services/market'
...
export function registerMarketHandlers() {
  ...
  ipcMain.handle('market:prev-day-intraday', (_e, symbol: string) => getPrevDayIntraday(symbol))
  ...
  ipcMain.handle('market:indices', () => getIndices())
  ipcMain.handle('market:sectors', () => getSectors())
}
